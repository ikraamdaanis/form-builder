...
export const HomeHeader = () => {
  ...
  return (
    <header className="fixed top-0 w-full border-b border-b-zinc-300 bg-primary bg-white py-4 dark:border-b-zinc-800 dark:bg-zinc-900">
      <nav className="mx-auto flex h-full w-full max-w-screen-xl items-center justify-between px-4">
